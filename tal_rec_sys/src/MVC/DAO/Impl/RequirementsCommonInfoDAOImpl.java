...
public class RequirementsCommonInfoDAOImpl implements RequirementsCommonInfoDAO {
    ...
    public List<Map> getDesc() throws Exception{
        ResultSet rs = CommonConnection.makeQuery("select ri_id,ri_desc,ri_req,departments.dp_name from requirements_common_info inner join departments on ri_dpt_id = departments.dp_id;",ConnectUser.DEV);
